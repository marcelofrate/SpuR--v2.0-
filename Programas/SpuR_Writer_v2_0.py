...
import SpuR_Writer_v2_0_python_mod as python_mod  # embedded python module
import sip
import time
import threading
...
class SpuR_Writer_v2_0(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SpuR (v2.0)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SpuR (v2.0)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SpuR_Writer_v2_0")
...
def main(top_block_cls=SpuR_Writer_v2_0, options=None):
